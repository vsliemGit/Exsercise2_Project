...
public class BanhMy extends Product{
	...
	void addMaterial() {
		...
		try {
			...
			System.out.println("Error: loi mua them - "+e);
		}
	...
	public String toString() {
		...
		return "Name product: "+ this.getNameProduct() + "  Materials: ["+ this.getMaterials()+"]" + " Price: " + this.getPrice()+ " Time: " + dtf.format(this.getDateTime());
	}
}
